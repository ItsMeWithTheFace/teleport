...
// RecoveryTokenGenerate is emitted when a user's recovery tokens are generated.
type RecoveryTokenGenerate struct {
	// Metadata is a common event metadata.
	Metadata `protobuf:"bytes,1,opt,name=Metadata,proto3,embedded=Metadata" json:""`
	// User is a common user event metadata.
	UserMetadata         `protobuf:"bytes,2,opt,name=User,proto3,embedded=User" json:""`
...
func (m *RecoveryTokenGenerate) Reset()         { *m = RecoveryTokenGenerate{} }
func (m *RecoveryTokenGenerate) String() string { return proto.CompactTextString(m) }
func (*RecoveryTokenGenerate) ProtoMessage()    {}
func (*RecoveryTokenGenerate) Descriptor() ([]byte, []int) {
	return fileDescriptor_8f22242cb04491f9, []int{25}
}
func (m *RecoveryTokenGenerate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoveryTokenGenerate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoveryTokenGenerate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoveryTokenGenerate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoveryTokenGenerate.Merge(m, src)
}
func (m *RecoveryTokenGenerate) XXX_Size() int {
	return m.Size()
}
func (m *RecoveryTokenGenerate) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoveryTokenGenerate.DiscardUnknown(m)
}

var xxx_messageInfo_RecoveryTokenGenerate proto.InternalMessageInfo

// RecoveryTokenUsed is emitted when a user's recovery tokens are used successfully or
// unsuccessfully..
...
func (m *RecoveryTokenUsed) Reset()         { *m = RecoveryTokenUsed{} }
func (m *RecoveryTokenUsed) String() string { return proto.CompactTextString(m) }
func (*RecoveryTokenUsed) ProtoMessage()    {}
func (*RecoveryTokenUsed) Descriptor() ([]byte, []int) {
	return fileDescriptor_8f22242cb04491f9, []int{26}
}
func (m *RecoveryTokenUsed) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RecoveryTokenUsed) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RecoveryTokenUsed.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RecoveryTokenUsed) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecoveryTokenUsed.Merge(m, src)
}
func (m *RecoveryTokenUsed) XXX_Size() int {
	return m.Size()
}
func (m *RecoveryTokenUsed) XXX_DiscardUnknown() {
	xxx_messageInfo_RecoveryTokenUsed.DiscardUnknown(m)
}

var xxx_messageInfo_RecoveryTokenUsed proto.InternalMessageInfo
...
type OneOf struct {
	...
	//	*OneOf_RecoveryTokenGenerate
	//	*OneOf_RecoveryTokenUsed
...
type OneOf_RecoveryTokenGenerate struct {
	RecoveryTokenGenerate *RecoveryTokenGenerate `protobuf:"bytes,49,opt,name=RecoveryTokenGenerate,proto3,oneof" json:"RecoveryTokenGenerate,omitempty"`
}
type OneOf_RecoveryTokenUsed struct {
	RecoveryTokenUsed *RecoveryTokenUsed `protobuf:"bytes,50,opt,name=RecoveryTokenUsed,proto3,oneof" json:"RecoveryTokenUsed,omitempty"`
}
...
func (*OneOf_RecoveryTokenGenerate) isOneOf_Event()     {}
func (*OneOf_RecoveryTokenUsed) isOneOf_Event()         {}
...
func (m *OneOf) GetRecoveryTokenGenerate() *RecoveryTokenGenerate {
	if x, ok := m.GetEvent().(*OneOf_RecoveryTokenGenerate); ok {
		return x.RecoveryTokenGenerate
	}
	return nil
}

func (m *OneOf) GetRecoveryTokenUsed() *RecoveryTokenUsed {
	if x, ok := m.GetEvent().(*OneOf_RecoveryTokenUsed); ok {
		return x.RecoveryTokenUsed
	}
	return nil
}
...
func (*OneOf) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*OneOf_RecoveryTokenGenerate)(nil),
		(*OneOf_RecoveryTokenUsed)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*RecoveryTokenGenerate)(nil), "events.RecoveryTokenGenerate")
	proto.RegisterType((*RecoveryTokenUsed)(nil), "events.RecoveryTokenUsed")
...
var fileDescriptor_8f22242cb04491f9 = []byte{
	...
	,
}
...
func (m *RecoveryTokenGenerate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoveryTokenGenerate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoveryTokenGenerate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RecoveryTokenUsed) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RecoveryTokenUsed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RecoveryTokenUsed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OneOf_RecoveryTokenGenerate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OneOf_RecoveryTokenGenerate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RecoveryTokenGenerate != nil {
		{
			size, err := m.RecoveryTokenGenerate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *OneOf_RecoveryTokenUsed) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OneOf_RecoveryTokenUsed) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RecoveryTokenUsed != nil {
		{
			size, err := m.RecoveryTokenUsed.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StreamStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n246, err246 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.LastUploadTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.LastUploadTime):])
	if err246 != nil {
		return 0, err246
	}
	i -= n246
	i = encodeVarintEvents(dAtA, i, uint64(n246))
	i--
	dAtA[i] = 0x1a
...
func (m *RecoveryTokenGenerate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecoveryTokenUsed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OneOf_RecoveryTokenGenerate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RecoveryTokenGenerate != nil {
		l = m.RecoveryTokenGenerate.Size()
		n += 2 + l + sovEvents(uint64(l))
	}
	return n
}
func (m *OneOf_RecoveryTokenUsed) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RecoveryTokenGenerate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoveryTokenGenerate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoveryTokenGenerate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RecoveryTokenUsed) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RecoveryTokenUsed: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RecoveryTokenUsed: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *OneOf) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 49:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecoveryTokenGenerate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RecoveryTokenGenerate{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &OneOf_RecoveryTokenGenerate{v}
			iNdEx = postIndex
		case 50:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecoveryTokenUsed", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Event = &OneOf_RecoveryTokenUsed{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
