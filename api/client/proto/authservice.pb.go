...
// ChangePasswordWithTokenRequest defines a request to change a user's password
// with password reset token.
type ChangePasswordWithTokenRequest struct {
	// SecondFactorToken is 2nd factor token value.
	SecondFactorToken string `protobuf:"bytes,1,opt,name=SecondFactorToken,proto3" json:"SecondFactorToken,omitempty"`
...
// ChangePasswordWithTokenResponse contains web session and account recovery as a response
// to user successfully changing their password.
type ChangePasswordWithTokenResponse struct {
	...
	RecoveryTokens       []string            `protobuf:"bytes,2,rep,name=recoveryTokens,proto3" json:"recoveryTokens,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *ChangePasswordWithTokenResponse) GetRecoveryTokens() []string {
	if m != nil {
...
// VerifyRecoveryTokenRequest defines a request to verify a user's password
// or second-factor and given recovery token.
type VerifyRecoveryTokenRequest struct {
	// username is the user's username.
	Username string `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"`
	// recoveryToken is one of the user's recovery token.
	RecoveryToken []byte `protobuf:"bytes,2,opt,name=recoveryToken,proto3" json:"recoveryToken,omitempty"`
	// password is user password.
	Password []byte `protobuf:"bytes,3,opt,name=password,proto3" json:"password,omitempty"`
	...
	// u2fSignResponse is U2F registration challenge response.
	U2FSignResponse      *U2FResponse `protobuf:"bytes,5,opt,name=u2fSignResponse,proto3" json:"u2fSignResponse,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *VerifyRecoveryTokenRequest) Reset()         { *m = VerifyRecoveryTokenRequest{} }
func (m *VerifyRecoveryTokenRequest) String() string { return proto.CompactTextString(m) }
func (*VerifyRecoveryTokenRequest) ProtoMessage()    {}
func (*VerifyRecoveryTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce8bd90b12161215, []int{94}
}
func (m *VerifyRecoveryTokenRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VerifyRecoveryTokenRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VerifyRecoveryTokenRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VerifyRecoveryTokenRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyRecoveryTokenRequest.Merge(m, src)
}
func (m *VerifyRecoveryTokenRequest) XXX_Size() int {
	return m.Size()
}
func (m *VerifyRecoveryTokenRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VerifyRecoveryTokenRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VerifyRecoveryTokenRequest proto.InternalMessageInfo

func (m *VerifyRecoveryTokenRequest) GetUsername() string {
	if m != nil {
		return m.Username
	}
	return ""
...
func (m *VerifyRecoveryTokenRequest) GetRecoveryToken() []byte {
	if m != nil {
...
func (m *VerifyRecoveryTokenRequest) GetPassword() []byte {
	if m != nil {
		return m.Password
	}
	return nil
...
func (m *VerifyRecoveryTokenRequest) GetSecondFactorToken() string {
	if m != nil {
		return m.SecondFactorToken
	}
	return ""
...
func (m *VerifyRecoveryTokenRequest) GetU2FSignResponse() *U2FResponse {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*VerifyRecoveryTokenRequest)(nil), "proto.VerifyRecoveryTokenRequest")
}
...
var fileDescriptor_ce8bd90b12161215 = []byte{
	...
	,
}
...
type AuthServiceClient interface {
	...
	// ChangePasswordWithToken changes a user's password with password reset token.
	...
	VerifyAccountRecoveryToken(ctx context.Context, in *VerifyRecoveryTokenRequest, opts ...grpc.CallOption) (*types.ResetPasswordTokenV3, error)
	// RecoverPasswordOrSecondFactor recover's a user's account by re-setting their password or
	// second factor.
	RecoverPasswordOrSecondFactor(ctx context.Context, in *ChangePasswordWithTokenRequest, opts ...grpc.CallOption) (*ChangePasswordWithTokenResponse, error)
}
...
func (c *authServiceClient) VerifyAccountRecoveryToken(ctx context.Context, in *VerifyRecoveryTokenRequest, opts ...grpc.CallOption) (*types.ResetPasswordTokenV3, error) {
	out := new(types.ResetPasswordTokenV3)
	err := c.cc.Invoke(ctx, "/proto.AuthService/VerifyAccountRecoveryToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) RecoverPasswordOrSecondFactor(ctx context.Context, in *ChangePasswordWithTokenRequest, opts ...grpc.CallOption) (*ChangePasswordWithTokenResponse, error) {
	out := new(ChangePasswordWithTokenResponse)
	err := c.cc.Invoke(ctx, "/proto.AuthService/RecoverPasswordOrSecondFactor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// VerifyAccountRecoveryToken verifies a given recovery token with a user's auth creds.
	VerifyAccountRecoveryToken(context.Context, *VerifyRecoveryTokenRequest) (*types.ResetPasswordTokenV3, error)
	// RecoverPasswordOrSecondFactor recover's a user's account by re-setting their password or
	// second factor.
	RecoverPasswordOrSecondFactor(context.Context, *ChangePasswordWithTokenRequest) (*ChangePasswordWithTokenResponse, error)
}
...
func (*UnimplementedAuthServiceServer) VerifyAccountRecoveryToken(ctx context.Context, req *VerifyRecoveryTokenRequest) (*types.ResetPasswordTokenV3, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifyAccountRecoveryToken not implemented")
}
func (*UnimplementedAuthServiceServer) RecoverPasswordOrSecondFactor(ctx context.Context, req *ChangePasswordWithTokenRequest) (*ChangePasswordWithTokenResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RecoverPasswordOrSecondFactor not implemented")
}
...
func _AuthService_VerifyAccountRecoveryToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyRecoveryTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).VerifyAccountRecoveryToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/VerifyAccountRecoveryToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).VerifyAccountRecoveryToken(ctx, req.(*VerifyRecoveryTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_RecoverPasswordOrSecondFactor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangePasswordWithTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).RecoverPasswordOrSecondFactor(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AuthService/RecoverPasswordOrSecondFactor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RecoverPasswordOrSecondFactor(ctx, req.(*ChangePasswordWithTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyAccountRecoveryToken",
			Handler:    _AuthService_VerifyAccountRecoveryToken_Handler,
		},
		{
			MethodName: "RecoverPasswordOrSecondFactor",
			Handler:    _AuthService_RecoverPasswordOrSecondFactor_Handler,
		},
	},
...
func (m *UserCertsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n24
	i = encodeVarintAuthservice(dAtA, i, uint64(n24))
	i--
	dAtA[i] = 0x1a
	if len(m.Username) > 0 {
		i -= len(m.Username)
...
func (m *GetEventsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n64, err64 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.EndDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.EndDate):])
	if err64 != nil {
		return 0, err64
	}
	i -= n64
	...
	i--
	dAtA[i] = 0x1a
	n65, err65 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.StartDate, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.StartDate):])
	if err65 != nil {
		return 0, err65
	}
	i -= n65
...
func (m *ChangePasswordWithTokenResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RecoveryTokens) > 0 {
		for iNdEx := len(m.RecoveryTokens) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RecoveryTokens[iNdEx])
			copy(dAtA[i:], m.RecoveryTokens[iNdEx])
			i = encodeVarintAuthservice(dAtA, i, uint64(len(m.RecoveryTokens[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *VerifyRecoveryTokenRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VerifyRecoveryTokenRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerifyRecoveryTokenRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.RecoveryToken) > 0 {
		...
		i = encodeVarintAuthservice(dAtA, i, uint64(len(m.RecoveryToken)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Username) > 0 {
...
func (m *ChangePasswordWithTokenResponse) Size() (n int) {
	...
	if len(m.RecoveryTokens) > 0 {
		for _, s := range m.RecoveryTokens {
			l = len(s)
			n += 1 + l + sovAuthservice(uint64(l))
		}
	}
...
func (m *VerifyRecoveryTokenRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ChangePasswordWithTokenResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.RecoveryTokens = append(m.RecoveryTokens, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuthservice(dAtA[iNdEx:])
...
func (m *VerifyRecoveryTokenRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VerifyRecoveryTokenRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VerifyRecoveryTokenRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.RecoveryToken = append(m.RecoveryToken[:0], dAtA[iNdEx:postIndex]...)
			if m.RecoveryToken == nil {
				m.RecoveryToken = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
